...
D6 rappresenta l'output non attendibile potenzialmente interpretato
come codice o comando. M2 genera tale output, M9 potrebbe inoltrarlo a
un ambiente eseguibile e M11 dovrebbe impedirne l'esecuzione. La
categoria rimane condizionata, poiché tali ambienti non sono presenti
...
Ogni scenario descrive una vera e propria catena d'attacco, specificando l'esempio reale di
attuazione nel contesto del digital human Al-Hakima, gli asset compromessi, l'impatto sulle
proprietà CIA$^3$-R, la giustificazione del punteggio di rischio e la mappatura formale sulle
tassonomie STRIDE-AI e OWASP Agentic.
...
Per neutralizzare il rischio inerente \textbf{CRITICO} dello Scenario~1 e spezzare la catena d'attacco a diversi livelli della pipeline, il sistema applica in modo integrato le precauzioni definite nella Sezione~\ref{sec:precauzioni}, mappate sui rispettivi asset coinvolti:
