...
proprietà CIA3$\to$R, la giustificazione del punteggio di rischio e la mappatura formale sulle
...
Al-Hakima come erogatrice di consigli di benessere e rimedi erboristici (Sezione~\ref{sec:contesto}),
...
Scenario~9 (\emph{Human-Agent Trust Exploitation}, Sezione~\ref{sec:sc9}), poiché la persuasività
...
\begin{enumerate}
    ...
    avvelenate nel RAG (cfr. Scenario SC6 -- Memory \& Context Poisoning, Sezione~\ref{sec:sc6}, di
...
considera l'intera catena di asset coinvolti (D1--D6, M1--M3, M11), individuati secondo i criteri
di selezione definiti in Sezione~\ref{sec:criteri-selezione}.
...
\subsubsection{Classificazione STRIDE-AI, Proprietà CIA3$\to$R Violate e Meccanismo del Threat}

La minaccia viene mappata secondo le categorie del modello STRIDE-AI, associandole alle
corrispondenti proprietà di sicurezza del modello CIA3$\to$R compromesse:
...
\begin{itemize}
    ...
    Tabella~\ref{tab:prioritizzazione}).
\end{itemize}
